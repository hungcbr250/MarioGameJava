...
public class ImGuiLayer {
    ...
    private boolean nhapTen = false;
    PlayerData playerData;
    ImString playerName = new ImString(256);
    String enterName;
    private boolean nhapTenXong = false;
    ...
    public void update(float dt, Scene currentScene) {
        ...
        if (!nhapTen) {
            ...
            if (ImGui.inputText("##NameInput", playerName, ImGuiInputTextFlags.EnterReturnsTrue)) {
                nhapTen = true;
                nhapTenXong = true;
            }
            ImGui.end();
        ...
        if (nhapTenXong) {
            ImGui.begin("Score");
            playerData = GameManager.getInstance().getPlayerByName(String.valueOf(playerName.get()));
            System.out.println("test1"+GameManager.getInstance().getPlayerData().getName());
            ImGui.text("Your Name: " + playerData.getName());
            ImGui.text("Your Score: " + playerData.getScore());
            ImGui.text("Your MaxScore: " + playerData.getMaxScore());
            ImGui.end();
        }
    ...
    public PlayerData nhapTen(String tenNhap) {
    ...
    private void setupDockspace() {
        ...
        //  int attack = GameManager.getInstance().getPlayerData(id).getChiso().getAttack();
