...
import org.example.physics2d.enums.JadeContactListener;
...
//    kiểm tra xem có va chạm nào xảy ra hay không và lấy ra va chạm đó
...
// Raycast hoạt động bằng cách phát ra một tia từ một điểm bắt đầu (origin point) theo một hướng (direction)
// cụ thể và kiểm tra xem tia này có gặp va chạm với đối tượng nào trong không gian hay không
...
//      raycastBegin sẽ bắt đầu ở từ trung tâm đối tượng thay vì ở cạnh
