...
public class Rigidbody2D extends Component {
    ...
    //cập nhật thông tin vị trí của tất cả các đối tượng
    @Override
    public void update(float dt) {
//  Nếu đối tượng được gắn lên 1 hình thức vật lí
        if (rawBody != null) {
            if (this.bodyType == BodyType.Dynamic || this.bodyType == BodyType.Kinematic) {
//           đồng bộ hóa vị trí của đối tượng trong trò chơi với vị trí của hình thức vật lý.
...
//           Cập nhật vận tốc tuyến tính của đối tượng trong trò chơi dựa
//           trên vận tốc tuyến tính của hình thức vật lý
